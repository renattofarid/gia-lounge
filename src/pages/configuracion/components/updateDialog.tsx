...
export function UpdateSettingModal({ station, open, onClose, onUpdateSuccess }: UpdateSettingProps) {
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-inter text-sm">Nombre</FormLabel>
                      <FormControl>
                        <Input
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-inter text-sm">Descripción</FormLabel>
                      <FormControl>
                        <Textarea
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-inter text-sm">Monto</FormLabel>
                      <FormControl>
                        <Input className="font-inter text-sm" placeholder="Monto" type="number" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
