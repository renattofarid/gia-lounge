...
export default function StationPage() {
  ...
  const [selectedEnvironmentId, setSelectedEnvironmentId] = useState<string | undefined>(environmentId)
  ...
  useEffect(() => {
    loadEnvironments(1)
    loadStations(1, selectedEnvironmentId ? Number(selectedEnvironmentId) : undefined)
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center w-full py-6 px-4 max-w-screen-2xl">
              ...
              <div className="flex gap-2 flex-col sm:flex-row w-full justify-end">
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  ...
                  <DialogContent className="p-6 max-w-3xl">
                    ...
                    <CreateStation environmentId={Number(selectedEnvironmentId)} onClose={handleClose} />
                  </DialogContent>
                </Dialog>
              </div>
            </div>
          ...
          <Table className="">
            <TableHeader>
              <TableRow>
                <TableHead className="font-inter text-base text-foreground text-star p-2">Nombre</TableHead>
                <TableHead className="font-inter text-base text-foreground text-center p-2">Tipo</TableHead>
                <TableHead className="font-inter text-base text-foreground text-center p-2">Estado</TableHead>
                <TableHead className="font-inter text-base text-foreground text-center p-2">Acciones</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
          ...
          <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
            <DialogContent className="p-6 max-w-3xl">
              <DialogHeader>
                <DialogTitle className="font-inter">Actualizar Mesa</DialogTitle>
                <DialogDescription />
              </DialogHeader>
              <UpdateStation
